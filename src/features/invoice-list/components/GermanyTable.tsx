...
export default function GermanyTable({ onAddRowHandlerReady }: { onAddRowHandlerReady?: (handler: () => void) => void }) {
  ...
  React.useEffect(() => {
    (window as any).__invoiceExportData = () => {
      exportToCSV('德国发票', filteredData as typeof data, columnDefs)
    }
    return () => {
